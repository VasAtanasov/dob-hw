create database if not exists bulgaria character set utf8 collate utf8_general_ci;
grant all on bulgaria.* to 'web_user'@'%' identified by 'Password1';
use bulgaria;
create table if not exists cities (id int primary key auto_increment, city_name varchar(50), population int);
